...
public class SubcategoryRepository {
	...
	private static final String SUBCATEGORY_BY_ID = "SELECT subcategory FROM SubcategoryEntity subcategory WHERE subcategory.id =?1 AND subcategory.active=true";

	private static final String SUBCATEGORY_BY_NAME = "SELECT subcategory FROM SubcategoryEntity subcategory where subcategory.name =?1 and subcategory.active = true";
	...
	public void softDeleteSubcategory(SubcategoryEntity subcategory) {
		subcategory.setActive(Boolean.FALSE);
		updateSubcategory(subcategory);
	}

	public void hardDeleteSubcategory(SubcategoryEntity subcategory) {
